...
const suggestions = [
  { name: "Double Cheeseburger", type: "Dish" },
  { name: "Pizza Hut", type: "Restaurant" },
  { name: "Sushi Master", type: "Restaurant" },
  { name: "Spicy Tacos", type: "Dish" },
];
            ...
            >
              <div className="p-6 border-b flex items-center gap-4">
                ...
                <input 
                  ...
                  className="flex-1 bg-transparent border-none outline-none text-xl font-bold"
                  value={searchQuery}
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-6 text-primary font-black text-xs uppercase tracking-widest">
                  <Flame className="w-4 h-4" /> Popular Searches
                </div>
