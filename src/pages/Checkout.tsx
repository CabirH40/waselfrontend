        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-8">
            <Card className="p-8 rounded-[2.5rem] border-none shadow-xl bg-white dark:bg-secondary">
              ...
              <div className="pr-16">
                <p className="font-bold text-lg">المنزل (دمشق)</p>
                <p className="text-muted-foreground font-medium">حي المزة، شارع الجلاء، بناية الياسمين</p>
              </div>
            </Card>
            ...
            <Card className="p-8 rounded-[2.5rem] border-none shadow-xl bg-white dark:bg-secondary">
              ...
              <div className="pr-16 flex items-center gap-4">
                <div className="bg-black text-white px-4 py-2 rounded-xl font-black text-xs tracking-widest">CASH</div>
            ...
            <Card className="p-8 rounded-[2.5rem] border-none shadow-2xl bg-white dark:bg-secondary sticky top-24">
              ...
              <div className="space-y-5 mb-8">
                <div className="flex justify-between font-bold">
                  <span className="text-muted-foreground">1x وجبة شاورما دبل</span>
                  <span>12,500 ل.س</span>
                </div>
                <div className="flex justify-between font-bold">
                  <span className="text-muted-foreground">1x بطاطا مقلية</span>
                  <span>4,500 ل.س</span>
                </div>
                <div className="border-t border-dashed pt-6 space-y-3">
                  <div className="flex justify-between font-bold text-sm">
                    <span className="text-muted-foreground">المجموع الفرعي</span>
                    <span>17,000 ل.س</span>
                  </div>
                  <div className="flex justify-between font-bold text-sm">
                ...
                <div className="border-t pt-6 flex justify-between items-center">
                  ...
                  <span className="text-3xl font-black text-primary">17,000 ل.س</span>
                </div>
              </div>
