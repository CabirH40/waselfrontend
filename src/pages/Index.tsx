...
import { Star, Clock, Bike, ChevronRight, Flame, Tag, Percent } from "lucide-react";
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-3xl md:text-4xl font-black tracking-tight">أقوى العروض الحالية</h2>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8 rounded-[3rem] bg-gradient-to-br from-primary to-red-600 text-white border-none shadow-2xl relative overflow-hidden group">
              <div className="relative z-10">
                <span className="bg-white/20 backdrop-blur-md px-4 py-1.5 rounded-full text-xs font-black mb-4 inline-block">عرض حصري</span>
                <h3 className="text-4xl font-black mb-4">خصم 30% على <br />جميع وجبات البرجر</h3>
                <p className="text-white/80 font-bold mb-8">يسري العرض حتى نهاية الأسبوع</p>
                <Button className="bg-white text-primary hover:bg-gray-100 rounded-2xl px-8 h-12 font-black">اطلب الآن</Button>
              </div>
              <div className="absolute -right-10 -bottom-10 w-64 h-64 opacity-20 group-hover:scale-110 transition-transform duration-700">
                <Flame className="w-full h-full" />
              </div>
            </Card>
            <Card className="p-8 rounded-[3rem] bg-gradient-to-br from-blue-600 to-indigo-700 text-white border-none shadow-2xl relative overflow-hidden group">
              <div className="relative z-10">
                <span className="bg-white/20 backdrop-blur-md px-4 py-1.5 rounded-full text-xs font-black mb-4 inline-block">توصيل مجاني</span>
                <h3 className="text-4xl font-black mb-4">توصيل مجاني <br />لأول 3 طلبات</h3>
                <p className="text-white/80 font-bold mb-8">للمستخدمين الجدد فقط</p>
                <Button className="bg-white text-blue-600 hover:bg-gray-100 rounded-2xl px-8 h-12 font-black">ابدأ الآن</Button>
              </div>
              <div className="absolute -right-10 -bottom-10 w-64 h-64 opacity-20 group-hover:scale-110 transition-transform duration-700">
