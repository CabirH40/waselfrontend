      ...
      <main className="container mx-auto px-4 py-6 md:py-10">
          ...
          >
            <div className="relative z-10 max-w-2xl">
              ...
              >
                ...
                <span>لفترة محدودة: خصم 50% على أول طلب</span>
              </motion.div>
            ...
            <div className="absolute left-0 top-0 w-full h-full opacity-30 lg:opacity-60">
              <img 
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl md:text-3xl font-black tracking-tight">ماذا يدور في ذهنك؟</h2>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl md:text-3xl font-black tracking-tight">المطاعم الشهيرة</h2>
                    ...
                    <Link to={`/restaurant/${res.id}`}>
                      <Card className="premium-card overflow-hidden rounded-[2.5rem] group border-none">
                        <div className="relative h-60 overflow-hidden">
                          ...
                          <div className="absolute bottom-4 left-4 bg-white/95 dark:bg-black/80 backdrop-blur-md px-3 py-1.5 rounded-2xl flex items-center gap-1.5 text-xs font-black shadow-xl">
                        ...
                        <div className="p-6 text-right">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground mb-5 font-bold justify-end">
